				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="<?php echo e(URL::to('/trang-chu')); ?>"><img src="<?php echo e(('public/frontend/images/home/logo.png')); ?>" alt="" /></a>
						</div>
			...
			?>
				...
				<div class="col-sm-4">
					<div class="signup-form"><!--sign up form-->
						<h2>Đăng ký</h2>
						<form action="<?php echo e(URL::to('/add-customer')); ?>">
							<input type="text" placeholder="Name"/>
							<input type="email" placeholder="Email Address"/>
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\blog\resources\views/user/login.blade.php ENDPATH**/ ?>