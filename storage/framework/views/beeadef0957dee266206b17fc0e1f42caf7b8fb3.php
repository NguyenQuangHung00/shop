...
<div class="product-details"><!--product-details-->
						<div class="col-sm-5">
							<div class="view-product">
								<img src="<?php echo e(asset('public/upload/product/'.$value ->product_image)); ?>" alt="" />
								<h3>ZOOM</h3>
							</div>
								  ...
								  <!-- Wrapper for slides -->
								    <div class="carousel-inner">
										<div class="item active">
										  <a href=""><img src="<?php echo e(asset('public/frontend/images/product-details/similar1.jpg')); ?>" alt=""></a>
										  <a href=""><img src="<?php echo e(asset('public/frontend/images/product-details/similar2.jpg')); ?>" alt=""></a>
										  <a href=""><img src="<?php echo e(asset('public/frontend/images/product-details/similar3.jpg')); ?>" alt=""></a>
										</div>
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								...
								<p><b>Tình trạng:</b> Còn hang</p>
								<p><b>Điều kiện:</b> <?php echo e($value ->product_desc); ?></p>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>					
					<div class="recommended_items"><!--recommended_items-->
						<h2 class="title text-center">Sản phẩm lliên quan</h2>
										...
										<div class="product-image-wrapper">
											<div class="single-products">
													<div class="productinfo text-center">
														<img src="<?php echo e(URL::to('public/upload/product/'.$lienquan->product_image)); ?>" alt="" />
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\blog\resources\views/page/sp/show_details.blade.php ENDPATH**/ ?>