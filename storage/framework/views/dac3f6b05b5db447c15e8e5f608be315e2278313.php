					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +848184214</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> LTMT2</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item active">
								...
								<div class="col-sm-6">
									<img src="<?php echo e(('public/frontend/images/home/girl1.jpg')); ?>" class="girl img-responsive" alt="" />
									<img src="<?php echo e(('public/frontend/images/home/pricing.png')); ?>"  class="pricing" alt="" />
								</div>
							</div>
							<div class="item">
								<div class="col-sm-6">
								...
								<div class="col-sm-6">
									<img src="<?php echo e(('public/frontend/images/home/girl2.jpg')); ?>" class="girl img-responsive" alt="" />
									<img src="<?php echo e(('public/frontend/images/home/pricing.png')); ?>"  class="pricing" alt="" />
								</div>
							</div>
							...
							<div class="item">
								...
								<div class="col-sm-6">
									<img src="<?php echo e(('public/frontend/images/home/girl3.jpg')); ?>" class="girl img-responsive" alt="" />
									<img src="<?php echo e(('public/frontend/images/home/pricing.png')); ?>" class="pricing" alt="" />
								</div>
							</div>
		...
		<div class="footer-top">
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-7">
							...
							<div class="video-gallery text-center">
								<a href="#">
									<div class="iframe-img">
										<img src="<?php echo e(('public/frontend/images/home/iframe1.png')); ?>" alt="" />
									</div>
						...
						<div class="col-sm-3">
							<div class="video-gallery text-center">
								<a href="#">
									<div class="iframe-img">
										<img src="<?php echo e(('public/frontend/images/home/iframe2.png')); ?>" alt="" />
									</div>
									<div class="overlay-icon">
										<i class="fa fa-play-circle-o"></i>
									</div>
						...
						<div class="col-sm-3">
							<div class="video-gallery text-center">
								<a href="#">
									<div class="iframe-img">
										<img src="<?php echo e(('public/frontend/images/home/iframe3.png')); ?>" alt="" />
									</div>
									<div class="overlay-icon">
										<i class="fa fa-play-circle-o"></i>
									</div>
						...
						<div class="col-sm-3">
							<div class="video-gallery text-center">
								<a href="#">
									<div class="iframe-img">
										<img src="<?php echo e(('public/frontend/images/home/iframe4.png')); ?>" alt="" />
									</div>
									<div class="overlay-icon">
										<i class="fa fa-play-circle-o"></i>
									</div>
					...
					<div class="col-sm-3">
						<div class="address">
							<img src="<?php echo e(('public/frontend/images/home/map.png')); ?>" alt="" />
